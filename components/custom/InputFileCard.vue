<template>
    <div class="w-full h-full max-w-[360px] max-h-[380px]  bg-white cursor-pointer rounded-md border p-2 border-[#DEE2E7]">
        <div v-if="!selectedFile && !props.modelValue" class="rounded-md border bg-[#F7FAFC] border-[#DEE2E7] flex items-center justify-center"
        ...
        <div v-if="selectedFile || modelValue" class=" overflow-hidden rounded-md border border-[#DEE2E7]">
            <img :src="props.modelValue || compressedBlobUrl || previewUrl">
        </div>
