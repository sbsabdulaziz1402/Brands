...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "c7b09476-3d22-4f7a-9d9d-53b41703d738",
...
const _lazy_mBA5Yc = () => import('../routes/api/compress.mjs');
const _lazy_WBWRsl = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/compress', handler: _lazy_mBA5Yc, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_WBWRsl, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WBWRsl, lazy: true, middleware: false, method: undefined }
];
