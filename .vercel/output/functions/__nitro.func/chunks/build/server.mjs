import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, ref, provide, defineAsyncComponent, h, computed, unref, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
...
const _routes = [
  ...
  },
  {
    name: "order-form-id",
    path: "/order-form/:id()",
    component: () => import('./_id_-Bt-d8r6U.mjs')
  },
  {
    name: "order-form",
    path: "/order-form",
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./nuxt-icon-CyqkF6fs.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CN_GSclM.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B-FQKIe3.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B1xWIhPL.mjs'));
